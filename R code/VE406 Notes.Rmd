...
Case study: remember the samll dataset, we do not have strong evidence 
...
4. there is any reason to use both drive-in time and dose to explain gain -> compre with the submodel using adjusted R-squared 
...
```{r}
sim_df = read.csv("/Users/yuxinmiao/Documents/JI/JI2020Fall/VE406/R code/in-class demo/Data/sim_poly_class.csv.bz2")
str(sim_df)
